...
<body style="text-align:center;">
       ...
       <?php
         ...
         if (isset($_POST['name']) && isset($_POST['password']) && isset($_POST['confirmPassword'])){
           ...
           if($password == $confirmPassword){
             echo "true";
             // Connection to DB
             $con = mysqli_connect($_config['HOST'],$_config['User'],$_config['Pass'],$_config['DB']) or die("Couldn't connect to DB");

             // Password Encryption
             $encPass = md5($password);

             // Insert Data to DB
             $sql = "INSERT INTO `login`(`name`, `password`) VALUES ('$name','$encPass')";
  ...
  <form action="#" method="POST" style="padding-top:150px;">
    <div class="col-md-4 col-md-offset-4">
      <h2 style="height:60px;color:white;padding-top:10px;">Register</h2>
        <input type="text" name="name" value="" placeholder="USERNAME" style="height:40px;width:55%;background-color:#272639;border:0px solid;padding:10px;color:white;border-radius:7px;">
        <br><br>
        ...
        <br><br>
        <input type="password" name="confirmPassword" value="" placeholder="CONFIRM PASSWORD" style="height:40px;width:55%;background-color:#272639;border:0px solid;padding:10px;color:white;border-radius:7px;">
        <br><br>
        <input type="submit" value="Register" style="background-color:#5A93D8;width:55%;height:35px;color:white;border-radius:7px;">
      </form>
       <p style="padding-top:30px;color:white;">I HAVE A ACCOUNT?<a href="login.php"><span style="color:#FFC107"> LOGIN NOW</span></a></p>
   </div>
  </div>
